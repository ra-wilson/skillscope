...
const COLOURS = ['#0088FE', '#00C49F', '#FFBB28', '#FF8042', '#8884d8', '#82ca9d', '#ffc658'];

export const ProgressDistributionChart = ({ data, title, description }: ProgressDistributionChartProps) => {
